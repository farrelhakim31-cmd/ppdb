        ...
        <div class="bg-white rounded-2xl shadow-xl overflow-hidden">
            ...
            <div class="bg-gradient-to-r from-blue-500 to-indigo-600 text-white p-6">
                <div class="flex items-center justify-between">
                    ...
                    <div class="text-right">
                        ...
                        @endphp
                        <span class="inline-block px-3 py-1 {{ $currentStatus['color'] }} text-white text-sm rounded-full">
                            {{ $currentStatus['label'] }}
                        </span>
                    </div>
                </div>
            ...
            <div class="p-6 border-b border-gray-100">
                ...
                <div class="space-y-3">
                    ...
                    <div class="border-l-4 border-gray-300 pl-3">
                        ...
                        <p class="font-semibold text-gray-800">{{ $registration->birth_place ?? '-' }}, {{ $registration->birth_date ? \Carbon\Carbon::parse($registration->birth_date)->format('d F Y') : '-' }}</p>
                    </div>
                    <div class="border-l-4 border-green-500 pl-3">
                        <p class="text-sm text-gray-600">Jenis Kelamin</p>
                        <p class="font-semibold text-gray-800">{{ $registration->gender == 'L' ? 'Laki-laki' : ($registration->gender == 'P' ? 'Perempuan' : '-') }}</p>
                    </div>
                    <div class="border-l-4 border-green-500 pl-3">
                        <p class="text-sm text-gray-600">Asal Sekolah</p>
                        <p class="font-semibold text-gray-800">{{ $registration->previous_school ?? '-' }}</p>
                    </div>
                    <div class="border-l-4 border-green-500 pl-3">
                        <p class="text-sm text-gray-600">Nama Orang Tua</p>
                        <p class="font-semibold text-gray-800">{{ $registration->parent_name ?? '-' }}</p>
                    </div>
                    <div class="border-l-4 border-blue-500 pl-3">
                    ...
                    <div class="border-l-4 border-green-500 pl-3">
                        ...
                        <p class="font-semibold text-gray-800">{{ $registration->created_at->format('d F Y H:i') }}</p>
                    </div>
                </div>
            </div>
            ...
            <div class="p-6">
                <div class="mb-6">
                    ...
                    <div class="bg-gray-50 rounded-lg p-4">
                        <div class="flex justify-between items-center mb-2">
                            ...
                            <span class="font-semibold">{{ $currentStep }}/{{ $totalSteps }} ({{ round($percentage) }}%)</span>
                        </div>
                ...
                <div class="text-center">
                    <a href="{{ route('siswa.dashboard') }}" class="bg-gray-500 text-white py-3 px-6 rounded-lg hover:bg-gray-600 transition-colors font-semibold">
