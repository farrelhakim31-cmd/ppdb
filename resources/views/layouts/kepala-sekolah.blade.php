        ...
        <div class="row g-0">
            <div class="col-md-2 sidebar">
                <div class="p-3">
                    <nav class="nav flex-column">
                        <a class="nav-link {{ request()->routeIs('kepala.dashboard') ? 'active' : '' }}" href="{{ route('kepala.dashboard') }}">
                            Dashboard
                        </a>
                        <a class="nav-link {{ request()->routeIs('kepala.reports') ? 'active' : '' }}" href="{{ route('kepala.reports') }}">
                            Laporan
                        </a>
                    </nav>
                </div>
            ...
            <div class="col-md-10 content-wrapper">
                <nav class="navbar navbar-expand-lg navbar-light bg-white shadow-sm">
                    <div class="container-fluid">
                        <span class="navbar-brand">@yield('page-title', 'Dashboard Kepala Sekolah')</span>
