...
<div class="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 py-8">
    <div class="max-w-4xl mx-auto px-4">
        ...
        <div class="bg-white rounded-2xl shadow-xl overflow-hidden">
            <form id="registrationForm" action="{{ route('ppdb.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div id="step1" class="step-content p-8">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div class="space-y-2">
                            ...
                            <input type="text" name="name" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all @error('name') border-red-500 @enderror" 
                        ...
                        <div class="space-y-2">
                            ...
                            <input type="email" name="email" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all @error('email') border-red-500 @enderror" 
                        ...
                        <div class="space-y-2">
                            ...
                            <input type="text" name="phone" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all @error('phone') border-red-500 @enderror" 
                        ...
                        <div class="space-y-2">
                            ...
                            <select name="gender" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all @error('gender') border-red-500 @enderror" required>
                        ...
                        <div class="space-y-2">
                            ...
                            <input type="text" name="birth_place" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all @error('birth_place') border-red-500 @enderror" 
                        ...
                        <div class="space-y-2">
                            ...
                            <input type="date" name="birth_date" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all @error('birth_date') border-red-500 @enderror" 
                    ...
                    <div class="mt-6 space-y-2">
                        ...
                        <textarea name="address" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all @error('address') border-red-500 @enderror" 
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
                        <div class="space-y-2">
                            ...
                            <input type="text" name="school_origin" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all @error('school_origin') border-red-500 @enderror" 
                                   value="{{ old('school_origin') }}" placeholder="Nama sekolah asal" required>
                            @error('school_origin')<p class="text-red-500 text-sm mt-1">{{ $message }}</p>@enderror
                        </div>

                        <div class="space-y-2">
                            <label class="block text-sm font-semibold text-gray-700">Pilihan Jurusan *</label>
                            <select name="major" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all @error('major') border-red-500 @enderror" required>
                                <option value="">Pilih Jurusan</option>
                                <option value="PPLG" {{ old('major') == 'PPLG' ? 'selected' : '' }}>Pengembangan Perangkat Lunak dan Gim (PPLG)</option>
                                <option value="DKV" {{ old('major') == 'DKV' ? 'selected' : '' }}>Desain Komunikasi Visual (DKV)</option>
                                <option value="ANIMASI" {{ old('major') == 'ANIMASI' ? 'selected' : '' }}>Animasi</option>
                                <option value="BDP" {{ old('major') == 'BDP' ? 'selected' : '' }}>Bisnis Daring dan Pemasaran (BDP)</option>
                ...
                <div id="step2" class="step-content p-8 hidden">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div class="space-y-2">
                            ...
                            <input type="text" name="parent_name" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all @error('parent_name') border-red-500 @enderror" 
                        ...
                        <div class="space-y-2">
                            ...
                            <input type="text" name="parent_phone" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all @error('parent_phone') border-red-500 @enderror" 
                    ...
                    <div class="mt-6 space-y-2">
                        ...
                        <input type="text" name="parent_job" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all @error('parent_job') border-red-500 @enderror" 
                               value="{{ old('parent_job') }}" placeholder="Pekerjaan orang tua/wali" required>
                        @error('parent_job')<p class="text-red-500 text-sm mt-1">{{ $message }}</p>@enderror
                    </div>
        ...
        <div class="text-center mt-8">
            <a href="{{ route('ppdb.index') }}" class="text-blue-600 hover:text-blue-800 font-medium">
