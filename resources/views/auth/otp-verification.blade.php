...
@section('title', 'Verifikasi OTP - PPDB Online')
    ...
    <div class="max-w-md w-full">
        <div class="bg-white rounded-xl shadow-lg border-0">
            ...
            <div class="p-6">
                ...
                <form action="{{ route('otp.verify') }}" method="POST" id="otpForm" class="space-y-4">
                    @csrf
                    <div>
