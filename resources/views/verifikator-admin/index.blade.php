...
<div class="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50 flex">
    ...
    <div class="w-64 shadow-lg fixed h-full" style="background: linear-gradient(135deg, #007bff 0%, #0056b3 100%);">
        <div class="p-6">
            ...
            <nav class="space-y-2">
                <a href="{{ route('verifikator-admin.dashboard') }}" class="flex items-center px-4 py-3 text-white hover:bg-white hover:bg-opacity-25 rounded-lg transition-colors">
                    <i class="fas fa-tachometer-alt mr-3"></i>Dashboard
                </a>
                <a href="{{ route('verifikator-admin.index') }}" class="flex items-center px-4 py-3 text-white bg-white bg-opacity-25 rounded-lg font-medium">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                {{ $registration->nama_lengkap ?? $registration->name ?? '-' }}
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                {{ $registration->jurusan_pilihan ?? $registration->major ?? '-' }}
                            </td>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                <a href="{{ route('verifikator-admin.show', $registration->id) }}" 
