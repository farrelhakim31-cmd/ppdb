<?php $__env->startSection('title', 'Dashboard Verifikator Administrasi'); ?>
...
<div class="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50 flex">
    ...
    <div class="w-64 shadow-lg fixed h-full" style="background: linear-gradient(135deg, #007bff 0%, #0056b3 100%);">
        <div class="p-6">
            ...
            <nav class="space-y-2">
                <a href="<?php echo e(route('verifikator-admin.dashboard')); ?>" class="flex items-center px-4 py-3 text-white bg-white bg-opacity-25 rounded-lg font-medium">
                    <i class="fas fa-tachometer-alt mr-3"></i>Dashboard
                </a>
                <a href="<?php echo e(route('verifikator-admin.index')); ?>" class="flex items-center px-4 py-3 text-white hover:bg-white hover:bg-opacity-25 rounded-lg transition-colors">
            ...
            <div class="bg-white rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 p-6 border border-slate-100">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-3xl font-bold text-slate-800"><?php echo e($stats['pending']); ?></p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 p-6 border border-slate-100">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-3xl font-bold text-slate-800"><?php echo e($stats['approved']); ?></p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 p-6 border border-slate-100">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-3xl font-bold text-slate-800"><?php echo e($stats['rejected']); ?></p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 p-6 border border-slate-100">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-3xl font-bold text-slate-800"><?php echo e($stats['revision']); ?></p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="overflow-x-auto">
                <table class="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        <?php $__empty_1 = true; $__currentLoopData = $recent_verifications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $log): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr>
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">
                                <?php echo e($log->registration->no_pendaftaran ?? $log->registration->registration_number ?? '-'); ?>

                            </td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                <?php echo e($log->registration->nama_lengkap ?? $log->registration->name ?? '-'); ?>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                <?php echo e($log->verifier->name); ?>

                            </td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                <?php echo e($log->verified_at->format('d/m/Y H:i')); ?>
...
<?php echo $__env->make('layouts.minimal', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\PC-08\Farrel_ujikom\resources\views/verifikator-admin/dashboard.blade.php ENDPATH**/ ?>