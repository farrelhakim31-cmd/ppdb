        ...
        <div class="content">
            ...
            <div class="info-box">
                ...
                <div class="info-row">
                    ...
                    <div class="info-value"><?php echo e($registration_number); ?></div>
                </div>
                <div class="info-row">
                    <div class="info-label">Jurusan:</div>
                    <div class="info-value"><?php echo e($major); ?></div>
                </div>
                <div class="info-row">
                    <div class="info-label">Email:</div>
                    <div class="info-value"><?php echo e($email); ?></div>
                </div>
                <div class="info-row">
                    <div class="info-label">No. Telepon:</div>
                    <div class="info-value"><?php echo e($phone); ?></div>
                </div>
                <div class="info-row">
                    <div class="info-label">Waktu Penerimaan:</div>
                    <div class="info-value"><?php echo e($accepted_at); ?></div>
                </div>
                <div class="info-row" style="border-bottom: none;">
                    <div class="info-label">Diterima Oleh:</div>
                    <div class="info-value"><?php echo e($accepted_by); ?></div>
                </div>
            </div>
...
<?php /**PATH C:\Users\PC-08\Farrel_ujikom\resources\views/emails/admin-notification.blade.php ENDPATH**/ ?>