<?php $__env->startSection('title', 'Dashboard Admin Panitia'); ?>
<?php $__env->startSection('page-title', 'Dashboard Admin Panitia'); ?>
            ...
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        ...
                        <h4 class="mb-0"><?php echo e($stats['total_pendaftar']); ?></h4>
                    </div>
            ...
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        ...
                        <h4 class="mb-0"><?php echo e($stats['hari_ini']); ?></h4>
                    </div>
            ...
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        ...
                        <h4 class="mb-0"><?php echo e($stats['terbayar']); ?></h4>
                    </div>
...
<div class="row">
    <div class="col-md-4 mb-3">
        <a href="<?php echo e(route('admin-panitia.monitoring')); ?>" class="card text-decoration-none stat-card">
    ...
    <div class="col-md-4 mb-3">
        <a href="<?php echo e(route('admin-panitia.map')); ?>" class="card text-decoration-none stat-card">
            <div class="card-body text-center">
                <div class="mb-3">
    ...
    <div class="col-md-4 mb-3">
        <a href="<?php echo e(route('admin-panitia.master-data')); ?>" class="card text-decoration-none stat-card">
            <div class="card-body text-center">
                <div class="mb-3">
...
<div class="row">
    <div class="col-md-6 mb-3">
        <a href="<?php echo e(route('admin-panitia.reports')); ?>" class="card text-decoration-none stat-card">
            <div class="card-body text-center">
                <div class="mb-3">
    ...
    <div class="col-md-4 mb-3">
        <a href="<?php echo e(route('admin-panitia.accounts')); ?>" class="card text-decoration-none stat-card">
            <div class="card-body text-center">
                <div class="mb-3">
    ...
    <div class="col-md-4 mb-3">
        <a href="<?php echo e(route('admin.map-settings.edit')); ?>" class="card text-decoration-none stat-card">
            <div class="card-body text-center">
                <div class="mb-3">
...
new Chart(trenCtx, {
    type: 'line',
    data: {
        labels: <?php echo json_encode(array_column($tren_harian, 'tanggal')); ?>,
        datasets: [{
            label: 'Pendaftar',
            data: <?php echo json_encode(array_column($tren_harian, 'pendaftar')); ?>,
            borderColor: '#007bff',
            backgroundColor: 'rgba(0, 123, 255, 0.1)',
            tension: 0.4
        }, {
            label: 'Terverifikasi',
            data: <?php echo json_encode(array_column($tren_harian, 'terverifikasi')); ?>,
            borderColor: '#28a745',
...
new Chart(jurusanCtx, {
    type: 'doughnut',
    data: {
        labels: <?php echo json_encode($per_jurusan->pluck('major')); ?>,
        datasets: [{
            data: <?php echo json_encode($per_jurusan->pluck('total')); ?>,
            backgroundColor: [
                '#007bff',
                '#28a745',
                '#ffc107',
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin-panitia', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\PC-08\Farrel_ujikom\resources\views/admin-panitia/dashboard.blade.php ENDPATH**/ ?>