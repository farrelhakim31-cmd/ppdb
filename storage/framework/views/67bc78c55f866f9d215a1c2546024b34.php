<?php $__env->startSection('title', 'Laporan - Admin Panitia'); ?>
        ...
        <div class="max-w-7xl mx-auto px-4 py-6">
            <div class="flex justify-between items-center">
                ...
                <div class="flex space-x-3">
                    ...
                    <a href="<?php echo e(route('admin-panitia.export')); ?>" class="bg-gradient-to-r from-blue-600 to-blue-700 text-white px-6 py-3 rounded-xl hover:from-blue-700 hover:to-blue-800 transition-all duration-200 shadow-lg">
            ...
            <div class="bg-white rounded-2xl shadow-lg p-6 border border-slate-100">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-4xl font-bold text-slate-800"><?php echo e($stats['total_pendaftar']); ?></p>
            ...
            <div class="bg-white rounded-2xl shadow-lg p-6 border border-slate-100">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-4xl font-bold text-slate-800"><?php echo e($stats['terverifikasi']); ?></p>
                        <p class="text-xs text-slate-500 mt-1"><?php echo e($stats['total_pendaftar'] > 0 ? round(($stats['terverifikasi'] / $stats['total_pendaftar']) * 100) : 0); ?>% dari total</p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-2xl shadow-lg p-6 border border-slate-100">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-4xl font-bold text-slate-800"><?php echo e($stats['terbayar']); ?></p>
                        <p class="text-xs text-slate-500 mt-1"><?php echo e($stats['total_pendaftar'] > 0 ? round(($stats['terbayar'] / $stats['total_pendaftar']) * 100) : 0); ?>% dari total</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="overflow-x-auto">
                <table class="min-w-full divide-y divide-slate-200">
                    ...
                    <tbody class="bg-white divide-y divide-slate-200">
                        <?php $__currentLoopData = $stats['per_jurusan']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $jurusan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-slate-900">
                                <?php echo e($jurusan->major ?? 'Tidak Diketahui'); ?>

                            </td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-slate-900">
                                <?php echo e($jurusan->total); ?>

                            </td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-slate-900">
                                <?php echo e($stats['total_pendaftar'] > 0 ? round(($jurusan->total / $stats['total_pendaftar']) * 100, 1) : 0); ?>%
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
                                <?php if($jurusan->total >= 30): ?>
                                    <span class="px-2 py-1 text-xs font-semibold rounded-full bg-green-100 text-green-800">Optimal</span>
                                <?php elseif($jurusan->total >= 20): ?>
...
new Chart(jurusanCtx, {
    type: 'bar',
    data: {
        labels: <?php echo json_encode($stats['per_jurusan']->pluck('major')); ?>,
        datasets: [{
            label: 'Jumlah Pendaftar',
            data: <?php echo json_encode($stats['per_jurusan']->pluck('total')); ?>,
            backgroundColor: [
                '#3b82f6',
                '#10b981',
                '#f59e0b',
...
new Chart(bulanCtx, {
    type: 'line',
    data: {
        labels: <?php echo json_encode($stats['per_bulan']->pluck('bulan')->map(function($bulan) { return ['Jan', 'Feb', 'Mar', 'Apr', 'Mei', 'Jun', 'Jul', 'Ags', 'Sep', 'Okt', 'Nov', 'Des'][$bulan-1] ?? $bulan; })); ?>,
        datasets: [{
            label: 'Pendaftar',
            data: <?php echo json_encode($stats['per_bulan']->pluck('total')); ?>,
            borderColor: '#8b5cf6',
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.minimal', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\PC-08\Farrel_ujikom\resources\views/admin-panitia/reports.blade.php ENDPATH**/ ?>