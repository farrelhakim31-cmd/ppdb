<?php $__env->startSection('title', 'Kelola Akun - Admin Panitia'); ?>
    ...
    <div class="max-w-7xl mx-auto px-4 py-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-6 gap-4 mb-8">
            ...
            <div class="bg-white rounded-2xl shadow-lg p-4 border border-slate-100">
                <div class="text-center">
                    ...
                    <p class="text-xl font-bold text-slate-800"><?php echo e($totalUsers); ?></p>
                </div>
            </div>
            ...
            <div class="bg-white rounded-2xl shadow-lg p-4 border border-slate-100">
                <div class="text-center">
                    ...
                    <p class="text-xl font-bold text-slate-800"><?php echo e($adminCount); ?></p>
                </div>
            </div>
            ...
            <div class="bg-white rounded-2xl shadow-lg p-4 border border-slate-100">
                <div class="text-center">
                    ...
                    <p class="text-xl font-bold text-slate-800"><?php echo e($verifikatorCount); ?></p>
                </div>
            </div>
            ...
            <div class="bg-white rounded-2xl shadow-lg p-4 border border-slate-100">
                <div class="text-center">
                    ...
                    <p class="text-xl font-bold text-slate-800"><?php echo e($keuanganCount); ?></p>
                </div>
            </div>
            ...
            <div class="bg-white rounded-2xl shadow-lg p-4 border border-slate-100">
                <div class="text-center">
                    ...
                    <p class="text-xl font-bold text-slate-800"><?php echo e($siswaCount); ?></p>
                </div>
            </div>
            ...
            <div class="bg-white rounded-2xl shadow-lg p-4 border border-slate-100">
                <div class="text-center">
                    ...
                    <p class="text-xl font-bold text-slate-800"><?php echo e($kepalaCount + $kepalaSekolahCount); ?></p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-2xl shadow-lg p-6 border border-slate-100 mb-6">
            <form method="GET" class="flex flex-col md:flex-row gap-4">
                <div class="flex-1">
                    <input type="text" name="search" value="<?php echo e(request('search')); ?>" placeholder="Cari nama atau email..." class="w-full px-4 py-3 border border-slate-300 rounded-lg focus:ring-2 focus:ring-purple-500">
                </div>
                <div class="md:w-48">
                    <select name="role" class="w-full px-4 py-3 border border-slate-300 rounded-lg focus:ring-2 focus:ring-purple-500">
                        ...
                        <option value="verifikator" <?php echo e(request('role') == 'verifikator' ? 'selected' : ''); ?>>Verifikator</option>
                        <option value="keuangan" <?php echo e(request('role') == 'keuangan' ? 'selected' : ''); ?>>Keuangan</option>
                        <option value="siswa" <?php echo e(request('role') == 'siswa' ? 'selected' : ''); ?>>Siswa</option>
                        <option value="kepala" <?php echo e(request('role') == 'kepala' ? 'selected' : ''); ?>>Kepala</option>
                    </select>
                </div>
                <div class="flex gap-2">
                    ...
                    <a href="<?php echo e(route('admin-panitia.accounts')); ?>" class="px-6 py-3 bg-slate-600 text-white rounded-lg hover:bg-slate-700">
        ...
        <div class="bg-white rounded-2xl shadow-lg overflow-hidden border border-slate-100">
            <div class="px-6 py-5 border-b border-slate-200 bg-gradient-to-r from-slate-50 to-purple-50">
                <div class="flex justify-between items-center">
                    ...
                    <span class="text-sm text-slate-600"><?php echo e($users->count()); ?> user ditemukan</span>
                </div>
            </div>
            <div class="overflow-x-auto">
                <table class="min-w-full divide-y divide-slate-200">
                    ...
                    <tbody class="bg-white divide-y divide-slate-200">
                        ...
                        <tr class="hover:bg-slate-50 <?php echo e(request('search') && (stripos($user->name, request('search')) !== false || stripos($user->email, request('search')) !== false) ? 'bg-yellow-50' : ''); ?>">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                ...
                                <?php elseif($user->role == 'kepala' || $user->role == 'kepala_sekolah'): ?>
                                    <span class="px-2 py-1 text-xs font-semibold rounded-full bg-indigo-100 text-indigo-800">Kepala Sekolah</span>
                                <?php else: ?>
                                    <span class="px-2 py-1 text-xs font-semibold rounded-full bg-gray-100 text-gray-800"><?php echo e(ucfirst($user->role)); ?></span>
                                <?php endif; ?>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-slate-900">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                <div class="flex space-x-2">
                                    <button onclick="editUser(<?php echo e($user->id); ?>)" class="bg-blue-600 text-white px-3 py-1 rounded-lg text-xs hover:bg-blue-700 transition-colors">
                                        <i class="fas fa-edit mr-1"></i>Edit
                                    </button>
                                    <?php if($user->id != auth()->id()): ?>
                                    <button onclick="deleteUser(<?php echo e($user->id); ?>)" class="bg-red-600 text-white px-3 py-1 rounded-lg text-xs hover:bg-red-700 transition-colors">
...
<div id="addUserModal" class="fixed inset-0 bg-black bg-opacity-50 hidden z-50 flex items-center justify-center p-4">
    <div class="bg-white rounded-2xl max-w-md w-full mx-4 p-6">
        ...
        <form method="POST" action="<?php echo e(route('admin-panitia.store-user')); ?>">
            <?php echo csrf_field(); ?>
            <div class="space-y-4">
                <div>
...
<?php echo $__env->make('layouts.minimal', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\PC-08\Farrel_ujikom\resources\views/admin-panitia/accounts.blade.php ENDPATH**/ ?>