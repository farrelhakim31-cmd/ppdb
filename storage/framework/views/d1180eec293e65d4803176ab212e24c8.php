            ...
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        ...
                        <h4 class="mb-0"><?php echo e($totalPendaftar); ?></h4>
                    </div>
            ...
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        ...
                        <h4 class="mb-0"><?php echo e($diterima); ?></h4>
                    </div>
            ...
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        ...
                        <h4 class="mb-0"><?php echo e($rasioTerverifikasi); ?>%</h4>
                    </div>
...
<div class="row">
    <div class="col-md-6 mb-3">
        <a href="<?php echo e(route('kepala.reports')); ?>" class="card text-decoration-none stat-card">
    ...
    <div class="col-md-6 mb-3">
        <a href="<?php echo e(route('kepala.export')); ?>" class="card text-decoration-none stat-card">
            <div class="card-body text-center">
                <div class="mb-3">
...
new Chart(trenCtx, {
    type: 'line',
    data: {
        labels: <?php echo json_encode(array_column($trenHarian, 'tanggal')); ?>,
        datasets: [{
            label: 'Pendaftar',
            data: <?php echo json_encode(array_column($trenHarian, 'pendaftar')); ?>,
            borderColor: '#6f42c1',
            backgroundColor: 'rgba(111, 66, 193, 0.1)',
            tension: 0.1
        }, {
            label: 'Terverifikasi',
            data: <?php echo json_encode(array_column($trenHarian, 'terverifikasi')); ?>,
            borderColor: '#28a745',
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.kepala-sekolah', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\PC-08\Farrel_ujikom\resources\views/kepala/dashboard.blade.php ENDPATH**/ ?>