<?php $__env->startSection('title', 'Login - PPDB Online'); ?>
...
<div class="min-h-screen flex items-center justify-center px-4 py-12">
    <div class="max-w-md w-full">
        ...
        <div class="text-center mb-8">
            ...
            <?php if(request('redirect') && str_contains(request('redirect'), 'register')): ?>
...
<?php echo $__env->make('layouts.minimal', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\PC-08\Farrel_ujikom\resources\views/auth/login.blade.php ENDPATH**/ ?>