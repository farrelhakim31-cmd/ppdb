<?php $__env->startSection('title', 'Pembayaran PPDB'); ?>
    ...
    <div class="max-w-2xl mx-auto px-4">
        ...
        <div class="bg-white rounded-2xl shadow-xl overflow-hidden">
            ...
            <div class="p-6">
                ...
                <form action="<?php echo e(route('ppdb.process-payment', $registration->registration_number)); ?>" method="POST" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="flex flex-col sm:flex-row gap-4">
                        ...
                        <a href="<?php echo e(route('ppdb.status', $registration->registration_number)); ?>" class="flex-1 bg-gray-500 text-white py-3 px-6 rounded-lg hover:bg-gray-600 transition-colors font-semibold text-center">
                            Cek Status Nanti
                        </a>
                    </div>
                </form>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\PC-08\Farrel_ujikom\resources\views/ppdb/payment.blade.php ENDPATH**/ ?>