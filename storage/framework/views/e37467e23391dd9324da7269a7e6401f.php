<?php $__env->startSection('title', 'Pilih Metode Pengiriman OTP - PPDB Online'); ?>
        ...
        <div class="bg-white rounded-xl shadow-lg border-0">
            ...
            <div class="p-6">
                <div class="text-center mb-6">
                    ...
                    <p class="text-gray-600 mb-2">Halo, <strong><?php echo e($user->name); ?></strong></p>
                ...
                <form action="<?php echo e(route('otp.set-delivery')); ?>" method="POST" class="space-y-4">
                    <?php echo csrf_field(); ?>
                        ...
                        <label class="flex items-center cursor-pointer">
                            ...
                            <div class="flex items-center">
                                ...
                                <div>
                                    ...
                                    <div class="text-sm text-gray-600"><?php echo e($email); ?></div>
                                </div>
                            </div>
                        </label>
                    </div>
                    ...
                    <!-- SMS Option -->
                    <div class="border border-gray-200 rounded-lg p-4 hover:border-blue-300 transition-colors <?php echo e(!$user->phone ? 'opacity-50' : ''); ?>">
                        <label class="flex items-center cursor-pointer <?php echo e(!$user->phone ? 'cursor-not-allowed' : ''); ?>">
                            <input type="radio" name="delivery_method" value="sms" class="mr-3" <?php echo e(!$user->phone ? 'disabled' : ''); ?>>
                            <div class="flex items-center">
                                <i class="fas fa-sms text-green-600 text-xl mr-3"></i>
                                <div>
                                    <div class="font-medium text-gray-800">SMS</div>
                                    <div class="text-sm text-gray-600">
                                        <?php echo e($user->phone ? $user->phone : 'Nomor telepon tidak tersedia'); ?>
                    ...
                    <div class="border border-gray-200 rounded-lg p-4 hover:border-blue-300 transition-colors <?php echo e(!$user->phone ? 'opacity-50' : ''); ?>">
                        <label class="flex items-center cursor-pointer <?php echo e(!$user->phone ? 'cursor-not-allowed' : ''); ?>">
                            <input type="radio" name="delivery_method" value="whatsapp" class="mr-3" <?php echo e(!$user->phone ? 'disabled' : ''); ?>>
                            <div class="flex items-center">
...
<?php echo $__env->make('layouts.minimal', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\PC-08\Farrel_ujikom\resources\views/auth/otp-delivery-choice.blade.php ENDPATH**/ ?>