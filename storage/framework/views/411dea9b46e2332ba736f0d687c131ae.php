<?php $__env->startSection('title', 'PPDB Online - SMK BAKTI NUSANTARA 666'); ?>
...
<div class="min-h-screen flex flex-col">
    ...
    <header class="bg-white shadow-sm border-b">
        <div class="max-w-6xl mx-auto px-4 py-4 flex justify-between items-center">
            <div class="flex items-center space-x-3">
                <img src="<?php echo e(asset('img/logo-sekolah.svg')); ?>" alt="Logo SMK BAKTI NUSANTARA 666" class="w-12 h-10 object-contain">
                <h1 class="text-xl font-semibold text-gray-900">SMK BAKTI NUSANTARA 666</h1>
            </div>
            <nav class="hidden md:flex space-x-6">
                <a href="<?php echo e(route('home')); ?>" class="text-gray-600 hover:text-blue-600 transition-colors">Beranda</a>
                <a href="<?php echo e(route('ppdb.index')); ?>" class="text-gray-600 hover:text-blue-600 transition-colors">Info PPDB</a>
                <a href="<?php echo e(route('login')); ?>" class="bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 transition-colors">Login</a>
            </nav>
        </div>
    </header>
    ...
    <main class="flex-1 flex items-center justify-center px-4 py-12">
        <div class="max-w-4xl mx-auto text-center">
            <!-- Logo & Title -->
            <div class="mb-8">
                <img src="<?php echo e(asset('img/logo-sekolah.svg')); ?>" alt="Logo SMK BAKTI NUSANTARA 666" class="w-24 h-20 object-contain mx-auto mb-4">
            ...
            <div class="grid md:grid-cols-2 gap-4 max-w-md mx-auto mb-12">
                <a href="<?php echo e(route('login', ['redirect' => route('ppdb.register')])); ?>" 
...
<?php echo $__env->make('layouts.minimal', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\PC-08\Farrel_ujikom\resources\views/home-minimal.blade.php ENDPATH**/ ?>