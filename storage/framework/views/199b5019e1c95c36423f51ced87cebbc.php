...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Dashboard Keuangan'); ?></title>
        ...
        <div class="row">
            <div class="col-md-3 col-lg-2 px-0 sidebar">
                <div class="p-3">
                    ...
                    <nav class="nav flex-column">
                        <a class="nav-link text-white <?php echo e(request()->routeIs('keuangan.dashboard') ? 'bg-white bg-opacity-25 rounded' : ''); ?>" href="<?php echo e(route('keuangan.dashboard')); ?>">
                            <i class="fas fa-tachometer-alt me-2"></i>Dashboard
                        </a>
                        <a class="nav-link text-white" href="<?php echo e(route('payments.verification')); ?>">
                            <i class="fas fa-check-circle me-2"></i>Verifikasi Pembayaran
                        </a>
                        <a class="nav-link text-white" href="<?php echo e(route('keuangan.ppdb')); ?>">
            ...
            <div class="col-md-9 col-lg-10 content-wrapper">
                <nav class="navbar navbar-expand-lg navbar-light bg-white shadow-sm">
                    <div class="container-fluid">
                        <span class="navbar-brand"><?php echo $__env->yieldContent('page-title', 'Dashboard Keuangan'); ?></span>
...
</html><?php /**PATH C:\Users\PC-08\Farrel_ujikom\resources\views/layouts/keuangan.blade.php ENDPATH**/ ?>