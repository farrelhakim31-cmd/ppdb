...
<body>
    <div class="container">
        ...
        <div class="content">
            <p>Kepada Yth. <strong><?php echo e($bill->student->name); ?></strong>,</p>
            ...
            <div class="bill-details">
                <div class="bill-row">
                    ...
                    <span class="value"><?php echo e($bill->description); ?></span>
                </div>
                <div class="bill-row">
                    <span class="label">Jumlah Tagihan:</span>
                    <span class="amount">Rp <?php echo e(number_format($bill->amount, 0, ',', '.')); ?></span>
                </div>
                <div class="bill-row">
                    <span class="label">Jatuh Tempo:</span>
                    <span class="value"><?php echo e(date('d F Y', strtotime($bill->due_date))); ?></span>
                </div>
                <div class="bill-row">
        ...
        <div class="footer">
            ...
            <p>&copy; <?php echo e(date('Y')); ?> SMK BAKTI NUSANTARA 666. All rights reserved.</p>
        </div>
    </div>
</body>
</html>
<?php /**PATH C:\Users\PC-08\Farrel_ujikom\resources\views/emails/bill-notification.blade.php ENDPATH**/ ?>